...
## 准备
这里研究的RocketMQ版本为4.9.4，查看当前[最新版本](https://github.com/apache/rocketmq/releases)。  
以下内容主要来源于[Apache RocketMQ开发者指南](https://github.com/apache/rocketmq/tree/master/docs/cn)  
